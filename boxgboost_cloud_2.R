...
hs <- makeParamSet( 
  ...
  makeIntegerParam("min_child_weight", lower=  0L   , upper=   1000L),    #groseramente equivalente a  min_data_in_leaf
  makeIntegerParam("max_depth",        lower=  2L   , upper=   1000L),    #profundidad del arbol, NO es equivalente a num_leaves
  makeIntegerParam("gamma",            lower=  0L   , upper=   100L),    
  makeNumericParam("subsample",        lower= 0.25, 1)
)

ksemilla_azar  <- 41191  #Aqui poner la propia semilla
